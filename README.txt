...
This package contains the data files for the Colobot project (https://github.com/adiblol/colobot).
...
given and the rights granted specifically to PPC community in March
2012. Since then, we have been modifying the code and working on our
goals, which are briefly summed up below.
